...
import QuoteCard from "../api/components/QuotesCard";
import { getAllQuotes, addQuote, updateQuote, deleteQuote } from "../api/quotesApi";
import { useFormValidation } from "../api/hooks/useValidation"; // IMPORT hook validare
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="sticky top-0 z-10 bg-white shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Link
            to="/"
            className="px-4 py-2 text-sm font-medium text-indigo-600 border
              border-indigo-600 rounded-lg hover:bg-indigo-600
