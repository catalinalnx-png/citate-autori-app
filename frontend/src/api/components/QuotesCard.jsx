    ...
    <div className="flex flex-col justify-between bg-white rounded-2xl shadow-md 
      ...
      <div>
        ...
        <div className="flex-1">
          ...
          <span className="text-5xl text-brand leading-none select-none">
            &ldquo;
          </span>
      ...
      {(onEdit || onDelete) && (
        <div className="flex gap-2 mt-4 pt-4 border-t border-gray-100">
          {onEdit && (
            <button
              onClick={() => onEdit(quote)} // onClick transmite întregul obiect 'quote' înapoi la ManagePage pentru a popula formularul de editare
          ...
          {onDelete && (
            <button
              onClick={() => onDelete(quote.id)} // onClick transmite doar ID-ul - necesar pentru DELETE
              className="flex-1 py-1.5 text-sm font-medium rounded-lg 
